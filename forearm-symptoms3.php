 ...
 <!-- <td><label style="margin-top : 5px">Do you have  &nbsp"<?php echo htmlentities($result->symptoms_name);?>"?</label> </td>
            <td>
                <div style="display:flex">
                    <div style="display:flex">
                        <input type="radio" id="<?php echo htmlentities($cnt);?>" name="<?php echo htmlentities($cnt);?>" value="yes" required>
                        <label for="<?php echo htmlentities($cnt);?>" style="margin-top : 7px">&nbsp Yes &nbsp &nbsp</label>
                    </div>
                    <div style="display:flex">
                        <input type="radio" id="<?php echo htmlentities($cnt);?>2" name="<?php echo htmlentities($cnt);?>" value="no" required>
                        <label for="<?php echo htmlentities($cnt);?>2" style="margin-top : 7px">&nbsp No</label>
                    </div>
                </div>
            </td>                                              -->
            <td class="result-color3">Do you have  &nbsp"<?php echo htmlentities($result->symptoms_name);?>"?</td>
            <td class="result-color3"><input type="radio" name="<?php echo htmlentities($cnt);?>" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="<?php echo htmlentities($cnt);?>" value="No" required>No </td>
...
<li><button type="submit" name="submit" >SUBMIT</button></li> 
     ...
     <div class="flex-p-inside">
     <div class="flex-p-1">
     <li><a href="forearm-symptoms2.php" ><button>Back</button></li>
</div>
</div>
